...
if (isset($_GET['error'])) {
  ...
  echo "<font color='red'><p align='center'>Incorrect ID or Password or Reg-no</p></font>";
}
...
<body>
<button class="new"><a class="admin" href="admin.php">Click here for ADMIN LOGIN</a></button>
  <form action="login.php" method="post">
<h2>WELCOME</h2>
    <p>Sign in</p>
    <div class="container">
      <b>REGISTRATION NO</b><br>
      <input class="reg" type="text" name="reg_no"  placeholder="Enter your reg no"required></input><br>
